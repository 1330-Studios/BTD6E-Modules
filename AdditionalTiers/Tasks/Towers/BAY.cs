...
internal class BAY : TowerTask
{
    ...
    public BAY()
    {
        ...
        gameLoad += gm =>
        {
            ...
            UpgradeMenuManager.towers["Black And Yellow Base"] = new UMM_Tower
            {
                CurrentUpgrade = 0,
                ...
                TowerType = "GROUND",
                UpgradeCost = 750_000,
                Portrait = "AdditionalTiers.Resources.B_Y.bypor.png",
                CurrentSPA = 0.1,
                CurrentDamage = 16,
                NextSPA = -0.05,
                NextDamage = 16,
                ...
                Extra = "",
                MaxUpgrade = false,
                NextUpgradeName = "Black And Yellow T1"
            };
            ...
            UpgradeMenuManager.towers["Black And Yellow T1"] = new UMM_Tower {
                CurrentUpgrade = 1,
                Name = "Black And Yellow",
                TowerModel = t1,
                TowerType = "GROUND",
                ...
                Extra = "",
                MaxUpgrade = false,
                NextUpgradeName = "Black And Yellow T2"
            };
            ...
            UpgradeMenuManager.towers["Black And Yellow T2"] = new UMM_Tower {
                CurrentUpgrade = 2,
                Name = "Black And Yellow",
                TowerModel = t2,
                TowerType = "GROUND",
