...
internal class KingCrimson : TowerTask
{
    ...
    public KingCrimson()
    {
        ...
        gameLoad += gm =>
        {
            ...
            UpgradeMenuManager.towers["King Crimson Base"] = new UMM_Tower {
                CurrentUpgrade = 0,
                Name = "King Crimson",
                TowerModel = baseTwrMdl,
                TowerType = "GROUND",
                UpgradeCost = 75_000,
                Portrait = "AdditionalTiers.Resources.V2.KingCrimson.KingCrimsonIcon.png",
                CurrentSPA = 0.55,
                CurrentDamage = 4,
                NextSPA = -0.05,
                NextDamage = 4,
                ...
                Extra = "",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T1"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T1"] = new UMM_Tower {
                CurrentUpgrade = 1,
                Name = "King Crimson",
                TowerModel = t1,
                TowerType = "GROUND",
                ...
                NextDamage = 56,
                NextRange = 5,
                Extra = "Septuple Shots",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T2"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T2"] = new UMM_Tower {
                CurrentUpgrade = 2,
                Name = "King Crimson",
                TowerModel = t2,
                TowerType = "GROUND",
                ...
                Extra = "",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T3"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T3"] = new UMM_Tower {
                CurrentUpgrade = 3,
                Name = "King Crimson",
                TowerModel = t3,
                TowerType = "GROUND",
                ...
                NextDamage = 0,
                NextRange = 0,
                Extra = "Burning Hearts",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T4"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T4"] = new UMM_Tower {
                CurrentUpgrade = 4,
                Name = "King Crimson",
                TowerModel = t4,
                TowerType = "GROUND",
                ...
                Extra = "",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T5"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T5"] = new UMM_Tower {
                CurrentUpgrade = 5,
                Name = "King Crimson",
                TowerModel = t5,
                TowerType = "GROUND",
                ...
                Extra = "Foresight",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T6"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T6"] = new UMM_Tower {
                CurrentUpgrade = 6,
                Name = "King Crimson",
                TowerModel = t6,
                TowerType = "GROUND",
                UpgradeCost = 7_500_000,
                Portrait = "AdditionalTiers.Resources.V2.KingCrimson.KingCrimsonIcon.png",
                CurrentSPA = 0.25,
                CurrentDamage = 1_000,
                NextSPA = -0.05,
                ...
                Extra = "",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T7"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T7"] = new UMM_Tower {
                CurrentUpgrade = 7,
                Name = "King Crimson",
                TowerModel = t7,
                TowerType = "GROUND",
                ...
                NextDamage = 7_500,
                NextRange = 15,
                Extra = "Explosive Thorns",
                MaxUpgrade = false,
                NextUpgradeName = "King Crimson T8"
            };
            ...
            UpgradeMenuManager.towers["King Crimson T8"] = new UMM_Tower {
                CurrentUpgrade = 8,
                Name = "King Crimson",
                TowerModel = t8,
                TowerType = "GROUND",
