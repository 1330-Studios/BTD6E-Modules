...
internal class Mystery : TowerTask
{
    ...
    public Mystery()
    {
        ...
        gameLoad += gm =>
        {
            ...
            UpgradeMenuManager.towers["??? Base"] = new UMM_Tower {
                CurrentUpgrade = 0,
                Name = "Richard",
                TowerModel = baseTwrMdl,
                TowerType = "GROUND",
                UpgradeCost = 750_000,
                Portrait = "AdditionalTiers.Resources.Ninja.RichardIcon.png",
                CurrentSPA = 0.55,
                CurrentDamage = 4,
                NextSPA = -0.05,
                NextDamage = 4,
                NextRange = 5,
                Extra = "Tyler \"Ninja\" Blevins",
                MaxUpgrade = false,
                NextUpgradeName = "??? T1"
            };
            ...
            UpgradeMenuManager.towers["??? T1"] = new UMM_Tower {
                CurrentUpgrade = 1,
                Name = "Tyler",
                TowerModel = t1,
                TowerType = "GROUND",
            ...
            UpgradeMenuManager.towers["??? T2"] = new UMM_Tower {
                CurrentUpgrade = 2,
                Name = "Fortnite",
                TowerModel = t2,
                TowerType = "GROUND",
            ...
            UpgradeMenuManager.towers["??? T3"] = new UMM_Tower {
                CurrentUpgrade = 3,
                Name = "Ninja",
                TowerModel = t3,
                TowerType = "GROUND",
                UpgradeCost = 0,
                Portrait = "AdditionalTiers.Resources.Ninja.EVILRICHARD.png",
                CurrentSPA = 0.25,
                CurrentDamage = 200,
                NextSPA = 0,
                NextDamage = 0,
